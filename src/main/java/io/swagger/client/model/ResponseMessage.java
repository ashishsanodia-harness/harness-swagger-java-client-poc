...
import io.swagger.client.model.ResponseMessageException;
...
public class ResponseMessage {
  ...
  private ResponseMessageException exception = null;

  /**
   * Gets or Sets failureTypes
   */
  @JsonAdapter(FailureTypesEnum.Adapter.class)
  public enum FailureTypesEnum {
    EXPIRED("EXPIRED"),
    ...
    public static FailureTypesEnum fromValue(String input) {
      for (FailureTypesEnum b : FailureTypesEnum.values()) {
        if (b.value.equals(input)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<FailureTypesEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final FailureTypesEnum enumeration) throws IOException {
        jsonWriter.value(String.valueOf(enumeration.getValue()));
      }

      @Override
      public FailureTypesEnum read(final JsonReader jsonReader) throws IOException {
        Object value = jsonReader.nextString();
        return FailureTypesEnum.fromValue((String)(value));
      }
    }
  }  @SerializedName("failureTypes")
  private List<FailureTypesEnum> failureTypes = null;

  public ResponseMessage code(CodeEnum code) {
    this.code = code;
    return this;
  }
  ...
  **/
  ...
  public ResponseMessage level(LevelEnum level) {
    this.level = level;
    return this;
  }
  ...
  **/
  ...
  public ResponseMessage exception(ResponseMessageException exception) {
  ...
  **/
  @Schema(description = "")
  public ResponseMessageException getException() {
    return exception;
  }

  public void setException(ResponseMessageException exception) {
    this.exception = exception;
  }

  public ResponseMessage failureTypes(List<FailureTypesEnum> failureTypes) {
    this.failureTypes = failureTypes;
    return this;
  }

  public ResponseMessage addFailureTypesItem(FailureTypesEnum failureTypesItem) {
    if (this.failureTypes == null) {
      this.failureTypes = new ArrayList<FailureTypesEnum>();
    }
    this.failureTypes.add(failureTypesItem);
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public List<FailureTypesEnum> getFailureTypes() {
    return failureTypes;
  }

  public void setFailureTypes(List<FailureTypesEnum> failureTypes) {
    this.failureTypes = failureTypes;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.code, responseMessage.code) &&
        Objects.equals(this.level, responseMessage.level) &&
        Objects.equals(this.message, responseMessage.message) &&
        Objects.equals(this.exception, responseMessage.exception) &&
        Objects.equals(this.failureTypes, responseMessage.failureTypes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, level, message, exception, failureTypes);
  }
  ...
  public String toString() {
    ...
    sb.append("    failureTypes: ").append(toIndentedString(failureTypes)).append("\n");
    sb.append("}");
    return sb.toString();
  }
