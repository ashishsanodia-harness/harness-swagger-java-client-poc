...
public class ParameterFieldListString {
  ...
  public ParameterFieldListString expressionValue(String expressionValue) {
  ...
  **/
  ...
  public ParameterFieldListString expression(Boolean expression) {
  ...
  **/
  ...
  public ParameterFieldListString value(List<String> value) {
    this.value = value;
    return this;
  }

  public ParameterFieldListString addValueItem(String valueItem) {
    if (this.value == null) {
  ...
  **/
  ...
  public ParameterFieldListString typeString(Boolean typeString) {
  ...
  **/
  ...
  public ParameterFieldListString inputSetValidator(InputSetValidator inputSetValidator) {
  ...
  **/
  ...
  public ParameterFieldListString jsonResponseField(Boolean jsonResponseField) {
  ...
  **/
  ...
  public ParameterFieldListString responseField(String responseField) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ParameterFieldListString parameterFieldListString = (ParameterFieldListString) o;
    return Objects.equals(this.expressionValue, parameterFieldListString.expressionValue) &&
        Objects.equals(this.expression, parameterFieldListString.expression) &&
        Objects.equals(this.value, parameterFieldListString.value) &&
        Objects.equals(this.typeString, parameterFieldListString.typeString) &&
        Objects.equals(this.inputSetValidator, parameterFieldListString.inputSetValidator) &&
        Objects.equals(this.jsonResponseField, parameterFieldListString.jsonResponseField) &&
        Objects.equals(this.responseField, parameterFieldListString.responseField);
  }
  ...
  public String toString() {
    ...
    sb.append("class ParameterFieldListString {\n");
