 ...
 */
@Schema(description = "This is Failure entity as defied in Harness")
...
public class Failure {
  ...
  public Failure status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public Failure code(CodeEnum code) {
    this.code = code;
    return this;
  }
  ...
  **/
  ...
  public Failure correlationId(String correlationId) {
  ...
  **/
  ...
  public Failure errors(List<ValidationError> errors) {
    this.errors = errors;
    return this;
  }

  public Failure addErrorsItem(ValidationError errorsItem) {
    if (this.errors == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.status, failure.status) &&
        ...
        Objects.equals(this.correlationId, failure.correlationId) &&
        Objects.equals(this.errors, failure.errors);
  }

  @Override
  public int hashCode() {
    return Objects.hash(status, code, message, correlationId, errors);
  }
